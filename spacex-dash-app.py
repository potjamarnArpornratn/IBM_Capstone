...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig1 = px.pie(filtered_df, values='counts', names='outcome', title='Total Success Launches for site ' + entered_site)
        return fig1
...
def get_scatter_plot(entered_site, slider):
    mask = (spacex_df['Payload Mass (kg)'] > slider[0]) & (spacex_df['Payload Mass (kg)'] < slider[1])
